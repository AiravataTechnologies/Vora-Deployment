...
const CommercialIndustrialPage = ({ onBack }) => {
  return (
    <ServicePageTemplate
      ...
      heroImage="https://images.pexels.com/photos/6720541/pexels-photo-6720541.jpeg"
...
const PowerDistributionPage = ({ onBack }) => {
  return (
    <ServicePageTemplate
      ...
      heroImage="https://images.pexels.com/photos/207541/pexels-photo-207541.jpeg"
...
const EnergyEfficiencyPage = ({ onBack }) => {
  return (
    <ServicePageTemplate
      ...
      heroImage="https://images.pexels.com/photos/414837/pexels-photo-414837.jpeg"
...
const ServicesSection = ({ onServiceClick }) => {
  ...
  const serviceCards = [
    ...
    },
    {
      ...
      image: "https://images.pexels.com/photos/6720541/pexels-photo-6720541.jpeg",
    },
    {
      id: 'power-distribution',
      title: "Power Distribution",
      description: "Efficient power distribution is critical for uninterrupted operations and long-term safety.",
      image: "https://images.pexels.com/photos/207541/pexels-photo-207541.jpeg",
    },
    {
